...
public class PanelPago extends JPanel{
	...
	public PanelPago() {
		...
		lblDineroFaltante = new JLabel("PRECIO BILLETE:");
		lblDineroFaltante.setBackground(Color.BLACK);
		...
		lblDineroIntroducido.setBackground(Color.BLACK);
		...
		lblVueltas.setBackground(Color.BLACK);
		...
		lblPrecio.setIcon(new ImageIcon("C:\\eclipse-workspace\\AAReto3MVC\\Cosas\\fondo3.jpg"));
